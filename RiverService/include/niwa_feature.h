#ifndef NIWA_FEATURE_H
#define NIWA_FEATURE_H

#include "feature.h"

class niwa_feature : public feature_of_interest {
public:
    niwa_feature(string name, utility::string_t id, lat_lon position, string_t host_url) {
        _name = name;
        _position = position;
        _id = id;
        _host_url = host_url;
